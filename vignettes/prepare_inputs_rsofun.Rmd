...
-   `elv` for elevation (m a.s.l.). If this is not known, *ingestr* may be used to extract information from a digital elevation model (e.g. by using ETOPO1 as source in *ingestr()*).
