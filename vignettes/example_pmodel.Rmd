...
## extract mean tmax of warmest month from worldclim for each site, see https://stineb.github.io/ingestr/articles/example.html#worldclim-3 -> new column in siteinfo data frame 'thome')
```
...
## fudge df_drivers for this example
...
```{r}
df_drivers$forcing[[1]]$rainf <- rsofun::df_drivers$forcing[[1]]$prec / (60*60*24)
