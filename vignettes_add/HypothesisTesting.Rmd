...
rsofun_out_annual_tile %>% 
  ggplot() +
  geom_line(aes(x = year, y = GPP),color="blue") +
  labs(title = "LM3-PPA with gs leuning photosynthesis method", subtitle = "rsofun output",
...
rsofun_out_annual_tile %>% 
  ggplot() +
  geom_line(aes(x = year, y = Rauto),color="blue") +
  labs(title = "LM3-PPA with gs leuning photosynthesis method", subtitle = "rsofun output",
...
rsofun_out_annual_tile %>% 
  ggplot() +
  geom_line(aes(x = year, y = plantC),color="blue") +
  labs(title = "LM3-PPA with gs leuning photosynthesis method", subtitle = "rsofun output",
